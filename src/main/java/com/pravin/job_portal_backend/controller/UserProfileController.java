...
//  public ResponseEntity<?> updateProfile(Authentication authentication,@RequestBody UpdateUserProfile request) {
//
//    String username = authentication.getName();
//    Optional<UserDetialsDto> currentUserOptional = userProfileService.findByUserName(username);
//
//    if (currentUserOptional.isEmpty()) {
//      return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body("Unauthorized");
//    }
//
//    UserDetialsDto currentUser = currentUserOptional.get();
//    boolean isAdmin = currentUser.getRole() != null &&
//        currentUser.getRole().equalsIgnoreCase("ADMIN");
//
//    UserDetialsDto targetUser = currentUser;
//
...
//      Optional<UserDetialsDto> userByEmailOptional = userProfileService.findByUserName(request.getEmail());
...
//    String username = authentication.getName();
//    Optional<UserDetialsDto> userOptional = userProfileService.findByUserName(username);
//
//    return userOptional
