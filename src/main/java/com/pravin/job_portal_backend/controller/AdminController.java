...
//    List<UserDetialsDto> users = adminUserService.getAll();
...
//    Optional<UserDetialsDto> optionalUser = userAuthService.findByEmail(username);
//    if (optionalUser.isEmpty()) {
//      return ResponseEntity.status(HttpStatus.NOT_FOUND).body("User not found: " + username);
//    }
//    UserDetialsDto user = optionalUser.get();
...
//    Optional<UserDetialsDto> user = userAuthService.saveUser(userDTO);
//    if (user.isPresent()) {
