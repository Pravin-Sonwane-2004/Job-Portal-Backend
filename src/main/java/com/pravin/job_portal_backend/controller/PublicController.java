...
//    Optional<UserDetialsDto> createdUser = userAuthService.saveUser(userDTO);
//
...
//      Optional<UserDetialsDto> userOptional = userProfileService.findByUserName(userDTO.getEmail());
//
//      if (userOptional.isEmpty()) {
//        return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body("User not found.");
//      }
//
//      UserDetialsDto user = userOptional.get(); // ✅ Now it's safe to call getId()
