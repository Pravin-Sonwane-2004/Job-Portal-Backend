...
//import com.pravin.job_portal_backend.mapper.user_mapper.UserMapper;
...
//
//    @Override
//    public Optional<UserDetialsDto> findByUserName(String email) {
...
//
//    @Override
//    public UserDetialsDto getUserProfile(Long userId) {
//        User user = repository.findById(userId)
//                .orElseThrow(() -> new UserNotFoundException("User not found with ID: " + userId));
